...
/**
 * The main alplinks configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_alplinks_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('alplinksname', 'alplinks'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'alplinksname', 'alplinks');
